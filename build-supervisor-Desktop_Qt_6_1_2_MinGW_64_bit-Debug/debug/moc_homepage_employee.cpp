...
QT_MOC_LITERAL(18, 35), // "on_pushButton_notas_fiscais_c..."
QT_MOC_LITERAL(54, 0), // ""
QT_MOC_LITERAL(55, 37) // "on_pushButton_gerar_relatorio..."

    },
    "HomePage_Employee\0on_pushButton_notas_fiscais_clicked\0"
    "\0on_pushButton_gerar_relatorio_clicked"
};
...
void HomePage_Employee::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HomePage_Employee *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->on_pushButton_notas_fiscais_clicked(); break;
        case 1: _t->on_pushButton_gerar_relatorio_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
const QMetaObject HomePage_Employee::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_HomePage_Employee_t
